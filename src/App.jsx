    ...
    <div className="app"><style>{styles}</style><div className="container">
      ...
      <div className="grid-main">
        <div className="card">
          ...
          <div className="hand-sticky-wrap"><TileRow tiles={hand} selectedIndex={selectedHandIndex} onTileClick={handleHandTileClick} /></div>
