...
const YAKU_GUIDE = {
  "1翻": [
    ...
    { name: "一発", han: "1翻", open: "門前限定", desc: "リーチ後、1巡以内にアガるとつく役です。途中で誰かが鳴くと消えます。", point: "作る役というより、リーチ後のボーナス役です。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","8s","9s"],["5p","5p"]] },
    { name: "門前清自摸和（ツモ）", han: "1翻", open: "門前限定", desc: "鳴かずに自分でツモってアガる役です。", point: "門前で進めている時は、リーチと一緒につくことも多いです。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","8s","9s"],["5p","5p"]] },
    ...
    { name: "平和", han: "1翻", open: "門前限定", desc: "順子4つ＋役牌ではない雀頭で作る役です。待ちは両面待ちが必要です。", point: "リーチと相性が良い基本役です。字牌を少なくして順子を作ります。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["6m","7m","8m"],["2p","2p"]] },
    { name: "一盃口", han: "1翻", open: "門前限定", desc: "同じ順子を2組作る役です。", point: "同じ色で同じ並びが2セットある時に見えます。", exampleGroups: [["2m","3m","4m"],["2m","3m","4m"],["5p","6p","7p"],["3s","4s","5s"],["8p","8p"]] },
    { name: "海底摸月", han: "1翻", open: "鳴きOK", desc: "局の最後のツモ牌でツモアガリするとつく役です。", point: "作る役ではなく、最後のツモという状況役です。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","8s","9s"],["5p","5p"]] },
    { name: "河底撈魚", han: "1翻", open: "鳴きOK", desc: "局の最後の捨て牌でロンアガリするとつく役です。", point: "作る役ではなく、最後の捨て牌という状況役です。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","8s","9s"],["5p","5p"]] },
    { name: "嶺上開花", han: "1翻", open: "鳴きOK", desc: "カンをした後に引く嶺上牌でツモアガリするとつく役です。", point: "カンが関係する状況役です。", exampleGroups: [["5z","5z","5z","5z"],["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","7s"]] },
    { name: "搶槓", han: "1翻", open: "鳴きOK", desc: "相手が加カンした牌でロンアガリするとつく役です。", point: "かなり珍しい状況役です。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","8s","9s"],["5p","5p"]] },
  ],
  "2翻": [
    { name: "ダブル立直", han: "2翻", open: "門前限定", desc: "鳴きが入っていない1巡目にテンパイしてリーチするとつく役です。", point: "配牌がかなり良い時の特殊なリーチです。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","8s","9s"],["5p","5p"]] },
    ...
    { name: "三暗刻", han: "2翻", open: "条件つき", desc: "暗刻を3つ作る役です。ポンした刻子は暗刻になりません。", point: "手の中で同じ牌が3枚ずつ集まっている時に候補になります。", exampleGroups: [["2m","2m","2m"],["5p","5p","5p"],["7s","7s","7s"],["3m","4m","5m"],["8p","8p"]] },
    { name: "三槓子", han: "2翻", open: "鳴きOK", desc: "槓子を3つ作る役です。", point: "かなり珍しい役です。カンが3回必要です。", exampleGroups: [["2m","2m","2m","2m"],["5p","5p","5p","5p"],["7s","7s","7s","7s"],["3m","4m","5m"],["8p","8p"]] },
    { name: "三色同順", han: "2翻（鳴き1翻）", open: "鳴きOK", desc: "萬子・筒子・索子で同じ数字の順子を作る役です。", point: "123、456、789など同じ並びを3色でそろえます。", exampleGroups: [["2m","3m","4m"],["2p","3p","4p"],["2s","3s","4s"],["6p","7p","8p"],["5z","5z"]] },
    { name: "三色同刻", han: "2翻", open: "鳴きOK", desc: "萬子・筒子・索子で同じ数字の刻子を作る役です。", point: "三色同順より珍しいです。ポンで作ることもあります。", exampleGroups: [["5m","5m","5m"],["5p","5p","5p"],["5s","5s","5s"],["2m","3m","4m"],["7z","7z"]] },
    { name: "一気通貫", han: "2翻（鳴き1翻）", open: "鳴きOK", desc: "同じ種類で123・456・789をそろえる役です。", point: "1色で縦に長くつながっている時に狙えます。", exampleGroups: [["1m","2m","3m"],["4m","5m","6m"],["7m","8m","9m"],["3p","4p","5p"],["7s","7s"]] },
    ...
    { name: "混老頭", han: "2翻", open: "鳴きOK", desc: "1・9・字牌だけで作る役です。順子は使えません。", point: "対々和や七対子と一緒になることが多いです。", exampleGroups: [["1m","1m","1m"],["9p","9p","9p"],["1s","1s","1s"],["5z","5z","5z"],["9m","9m"]] },
  ...
  "3翻以上": [
    { name: "二盃口", han: "3翻", open: "門前限定", desc: "一盃口を2つ作る役です。七対子ではなく、同じ順子2組が2セット必要です。", point: "かなり難しい門前役です。", exampleGroups: [["2m","3m","4m"],["2m","3m","4m"],["6p","7p","8p"],["6p","7p","8p"],["5s","5s"]] },
  ...
  "役満": [
    ...
    { name: "小四喜", han: "役満", open: "鳴きOK", desc: "東南西北のうち3つを刻子、残り1つを雀頭にする役です。", point: "風牌がかなり集まった時にだけ見ます。", exampleGroups: [["1z","1z","1z"],["2z","2z","2z"],["3z","3z","3z"],["4z","4z"],["2m","3m","4m"]] },
    { name: "大四喜", han: "役満", open: "鳴きOK", desc: "東南西北をすべて刻子にする役です。", point: "非常に珍しい風牌の役満です。", exampleGroups: [["1z","1z","1z"],["2z","2z","2z"],["3z","3z","3z"],["4z","4z","4z"],["8p","8p"]] },
    ...
    { name: "清老頭", han: "役満", open: "鳴きOK", desc: "数牌の1・9だけで作る役です。字牌は使いません。", point: "1・9だけで刻子を作る、とても珍しい役満です。", exampleGroups: [["1m","1m","1m"],["9m","9m","9m"],["1p","1p","1p"],["9s","9s","9s"],["1s","1s"]] },
    { name: "緑一色", han: "役満", open: "鳴きOK", desc: "緑色の牌だけで作る役です。一般的には2索・3索・4索・6索・8索・發を使います。", point: "使える牌がかなり限られる特殊な役満です。", exampleGroups: [["2s","3s","4s"],["2s","3s","4s"],["6s","6s","6s"],["8s","8s","8s"],["6z","6z"]] },
    ...
    { name: "四槓子", han: "役満", open: "鳴きOK", desc: "槓子を4つ作る役です。", point: "最も珍しい部類の役満です。", exampleGroups: [["1m","1m","1m","1m"],["5p","5p","5p","5p"],["7s","7s","7s","7s"],["5z","5z","5z","5z"],["9p","9p"]] },
    { name: "天和", han: "役満", open: "親限定", desc: "親が配牌14枚の時点でアガっている役満です。", point: "作る役ではなく、配牌で決まる超特殊役です。", exampleGroups: [["2m","3m","4m"],["3p","4p","5p"],["4s","5s","6s"],["7s","8s","9s"],["5p","5p"]] },
